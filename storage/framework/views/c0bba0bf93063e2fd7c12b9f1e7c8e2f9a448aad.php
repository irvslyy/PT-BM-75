...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/elegant-font.css')); ?>">
...
<body>
            ...
            <div class="row h-100">
                <div class="col-12 h-100">
                    <nav class="h-100 navbar navbar-expand-lg align-items-center">
                        <a class="navbar-brand" href="index.html">BM75</a>
                        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#fancyNav" aria-controls="fancyNav" aria-expanded="false" aria-label="Toggle navigation"><i class="fas fa-align-justify"></i></button>
    ...
    <!-- ***** Hero Area Start ***** -->
    <div class="fancy-hero-area bg-img bg-overlay animated-img" style="background-image: url(img/bg-img/header.jpg);">
                        ...
                        <div class="row no-gutters">
                            <div class="col-12 col-md-4">
                                <div class="single-top-feature">
                                    <h5><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> Electrical</h5>
                                    <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. </p>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="single-top-feature">
                                    <h5><i class="fa fa-clock-o" aria-hidden="true"></i> Mechanical</h5>
                                    <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. </p>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="single-top-feature">
                                    <h5><i class="fa fa-diamond" aria-hidden="true"></i> Air system</h5>
                                    <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    ...
                    <div class="testimonials-slides owl-carousel">
                        ...
                        <div class="single-testimonial d-md-flex align-items-center">
                           ...
                           <div class="row">
                                <div class="col-md-3"><img src="<?php echo e(asset('img/logo/zara.png')); ?>"></div>
                                <div class="col-md-3"><img src="<?php echo e(asset('img/logo/newlook.png')); ?>" class="mt-5"></div>
                                <div class="col-md-3"><img src="<?php echo e(asset('img/logo/mango2.png')); ?>"></div>
                                <div class="col-md-3"><img src="<?php echo e(asset('img/logo/lacoste.jpg')); ?>"></div>
                           </div> 
                        ...
                        <div class="single-testimonial d-md-flex align-items-center">
                            <div class="row">
                                <div class="col-md-3"><img src="<?php echo e(asset('img/logo/birken.jpg')); ?>" alt=""></div>
                                <div class="col-md-3"><img src="<?php echo e(asset('img/logo/kipling.png')); ?>" alt="" class="mt-4"></div>
                                <div class="col-md-3"><img src="<?php echo e(asset('img/logo/swat.jpg')); ?>" alt="" class="mt-4"></div>
                                <div class="col-md-3"><img src="<?php echo e(asset('img/logo/mark.jpg')); ?>" alt="" class=""></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-4">
                    <div class="single-blog-area wow fadeInUp" data-wow-delay="0.5s">
                        <img src="<?php echo e(asset('/thumbnail/'. $blogs->IMAGE)); ?>" alt="err">
                        <div class="blog-content">
                            <h5><a href="#"><?php echo str_limit($blogs->TITLE,35); ?></a></h5>
                            <p><?php echo str_limit($blogs->DESC,100); ?></p>
                            <a href="#">read More</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget">
                            <h6>Contact Us</h6>
                            <p>+62 813-8152-0770 <br>agusdpkservice@yahoo.com
                            </p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |  by PT.BM-75 
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- ***** Footer Area End ***** -->
    <script defer src="<?php echo e(asset('js/font/brands.js')); ?>"></script>
    <script defer src="<?php echo e(asset('js/font/solid.js')); ?>"></script>
    <script defer src="<?php echo e(asset('js/font/fontawesome.js')); ?>"></script>
    <!-- jQuery-2.2.4 js -->
