...
<body>
	...
	<div id="wrapper">
			...
			<div class="container-fluid">
				...
				<div id="navbar-menu">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="" class="img-circle"> <span>  <?php echo e(Auth::user()->name); ?> </span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
							<ul class="dropdown-menu">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="<?php echo e(route('home')); ?>" class="active"><i class="lnr lnr-home"></i> Dashboard</a></li>	
						<li><a href="<?php echo e(route('welcome')); ?>" target="_blank"><span>view blog</span></a></li>						
						<li><a href="<?php echo e(route('blog.index')); ?>" class=""> <i class="fas fa-pen"></i> create post</a></li>
						<li><a href="" class=""> <i class="fas fa-calculator"></i> accounting</a></li>
						<li><a href="<?php echo e(route('material.index')); ?>" class=""> <i class="fas fa-shopping-cart"></i> data material</a></li>
						<li><a href="<?php echo e(route('report.index')); ?>" class=""> <i class="fas fa-chart-line"></i> reporting</a></li>
						<li>
						...
						<li><a href="<?php echo e(route('inventory')); ?>" class=""><i class="fas fa-archive"></i> inventory </a></li>
						<li><a href="<?php echo e(route('manage.users')); ?>" class=""><i class="fas fa-users"></i> </i> Manage Users </a></li>
						<li><a href="panels.html" class=""><i class="lnr lnr-cog"></i> <span>Setting</span></a></li>
						<li><a href="<?php echo e(route('welcome')); ?>" target="_blank"><i class="fas fa-trash"></i> trash</a></li>				
					</ul>
				</nav>
			</div>
		</div>
	...
	<script src="<?php echo e(asset('jschart/system.js')); ?>"></script>
