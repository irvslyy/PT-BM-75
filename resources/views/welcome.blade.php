                ...
                <div class="col-12">
                    ...
                    <div class="testimonials-slides owl-carousel">
                        ...
                        <div class="single-testimonial d-md-flex align-items-center">
                           ...
                           <div class="row">
                                <div class="col-md-3"><img src="{{asset('img/logo/zara.png')}}"></div>
                                <div class="col-md-3"><img src="{{asset('img/logo/newlook.png')}}" class="mt-5"></div>
                                <div class="col-md-3"><img src="{{asset('img/logo/mango2.png')}}"></div>
                                <div class="col-md-3"><img src="{{asset('img/logo/lacoste.jpg')}}"></div>
                           </div> 
                        ...
                        <div class="single-testimonial d-md-flex align-items-center">
                            <div class="row">
                                <div class="col-md-3"><img src="{{asset('img/logo/birken.jpg')}}" alt=""></div>
                                <div class="col-md-3"><img src="{{asset('img/logo/kipling.png')}}" alt="" class="mt-4"></div>
                                <div class="col-md-3"><img src="{{asset('img/logo/swat.jpg')}}" alt="" class="mt-4"></div>
                                <div class="col-md-3"><img src="{{asset('img/logo/mark.jpg')}}" alt="" class=""></div>
                            </div>
                        </div>
                    </div>
